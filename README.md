...
на экране Профиль на WEB. На найденные дефекты завести баг-репорты. 
   ...
   Задание 4.1: Провести тестирование блока “Лента и отображение поста”  приложения GP с помощью мобильной фермы.
   	        Заполняется тестовая документация по шаблону
...
Решение: [Тест-кейсы, чек-листы и  баг-репорты на блок "Лента и отображение" социальной сети для тестировщиков](https://docs.google.com/spreadsheets/d/1fnSzUkALVyCrnaP7H8E1JDilSr8nyxzT7tq6Oj-YtKM/edit?usp=sharing)
  ...
  Заполняется тестовая документация по шаблону
   ...
   Задание 4.3: Нефункциональное тестирование мобильных приложений
   
  	 Задание 1. Провести тестирование английской локализации приложения Юла.

	1) Сменить на устройстве язык на английский.
	2) Скачать приложение Юла, изучить основные экраны (главная, поиск, фильтры, личный кабинет)
	3) Составить чек-лист для тестирования локализации чтобы убедиться, что на всех проверенных экранах все отображается корректно.
	4) Провести тестирование по чек листу.
	5) При наличии багов - завести баг-репорт.
        Заполняется тестовая документация по шаблону
	
	 Задание 2: Провести тестирование установки мобильного приложения GP.
  
	1) Составить чек-лист на тестирование установки и удаления (можно взять из лекции)
	2) Провести тестирование по чек листу.
	3) При наличии багов - завести баг-репорт.
	Заполняется тестовая документация по шаблону  

 	 Задание 3: Оценить производительность и работоспособность приложения GP.
   
	1) Создать эмулятор в Android Studio (либо запустить если уже есть).
	2) Создать искуственную нагрузку.
	3) Запустить приложение GP и проверить работает ли основной функционал.
	Задание рекомендуется выполнять на эмуляторе. 
	Предоставить google docs, с прикрепленным скриншотом adb и эмулятора и краткие выводы о проведение стрессового тестирования.

   Решение: [Чек-листы, баг-репорты на нефункциональное тестирование мобильных приложений](https://docs.google.com/spreadsheets/d/1eVq-T1bNPTpHET7XUsE6pmzbCxcKhRDyBk-cTSTKkXM/edit?usp=sharing)
